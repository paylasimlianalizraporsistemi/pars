  ...
  onSubmit = (event) => {
    ...
    ipfs.add(this.state.buffer, (error, result) => {
      ...
      this.state.contract.methods
        .createReport(reportHash, reportName, reportType)
      ...
      <Router>
        <div class="">
          ...
          <Switch>
            ...
            <Route path="/roles" component={SetRole} />
    ...
    <div class="mx-auto" style={{ width: '1080px' }}>
      <div class="slider clearfix" style={{ marginTop: '100px' }}>
        <h1 class="mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7">
          <span class="" style={{ fontFamily: '"Cinzel", cursive' }}>
            PARS{' '}
          </span>
          <br />
        </h1>
        <h2 class="font-weight-light mt-5">
          ...
          and distributed lab report system.
        </h2>
        <a style={{ textDecoration: 'none' }} href="/reports">
      ...
      <div class="supporters">
        ...
        <div class="row">
          <div
            class="col-sm m-2 text-center"
            style={{ height: '220px', background: '#dadada' }}
          >
            <img
              src={msku}
              height="150"
      ...
      <footer>
        <div class="text-center p-4">
          © 2022
          <a class="text-reset fw-bold" href="https:///"></a>
        </div>
      </footer>
    </div>
  </div>
